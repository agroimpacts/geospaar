...
## Step 2: Install R
Go to [R page](https://www.r-project.org) and download the current stable release, R 4.1.2, using the correct version for your operating system (Linux x86, Mac, Windows, etc).
