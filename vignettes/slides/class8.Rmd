...
1. Use `lapply` and `sapply` to calculate the `colSum` (columns "pl", "ra", "mm") for observations where "uuid" contains the values "8424", "166f", "99f9"
...
```{r}
sapply(c("8424", "166f", "99f9"), function(x) {
