...
```{r, eval = FALSE}
dat[dat$d == "puppies", 1]  # all values from a where d == "pigs"
dat[dat$d == "puppies", "a"]  # all values from a where d == "pigs"
dat[dat[, 4] == "puppies", 1]  # all values from a where d == "pigs"
dat[dat[, 4] == "puppies", "a"]  # all values from a where d == "pigs"
