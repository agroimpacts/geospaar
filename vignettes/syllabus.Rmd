...
---------|------------------|------------------
Michael Cecil   | EORS Lab (**Virtual appointments only**) | Tuesday 1300-1500 
...
# a <- c(20, 30, 40)
# a / sum(a)
mat <- rbind(c("Practical assignments (n=5)", "55% of grade", "55% of grade"), 
             c("Partcipiation", "10% of grade", "10% of grade"),
