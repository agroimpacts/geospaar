...
## Philosophy
Although our primary focus is learning how to use `R` for geospatial analysis, the course also introduces additional skills and concepts related to ___reproducible___ research, and covers how and why `R` capabilities can and should be fit into analytical workflows that are increasingly driven by AI. 
...
___Exam___. At the end of the first two units, we will also give an in-class coding exam that covers some of the key programming and reproducibility concepts covered. 
...
# a <- c(20, 30, 40)
# a / sum(a)
mat <- rbind(c("Practical assignments (n=5)", "40% of grade", "30% of grade"), 
             c("Exam", "15% of grade", "15% of grade"),
             c("Participation", "10% of grade", "10% of grade"),
             c("Overview for final semester project", "10% of grade", 
               "15% of grade"),
...
DF <- cbind.data.frame(c("Class meetings/exam", "Readings", "Practicals", 
...
## Career readiness
The skills you will develop through this course are important to future employers. While you may find opportunities during the semester to grow in all eight Career Competencies, the learning goals of this course most closely relate to [competencies](https://www.clarku.edu/curriculum-and-careers/career-readiness-competencies/) in Critical Thinking, Professionalism, Teamwork, Technology, and (Quantitative) Communication. 
