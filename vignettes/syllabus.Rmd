...
```{r, echo = FALSE}
DF <- rbind(c("Practical assignments (n=6)", "30% of grade", "20% of grade"), 
            c("Oral presentation of semester project", "20% of grade", 
              "30% of grade"),
            c("Final report on semester project", "40% of grade", 
              "40% of grade"))
colnames(DF) <- c("Component", "GEOG246", "GEOG346")
kable(DF)                 
```
