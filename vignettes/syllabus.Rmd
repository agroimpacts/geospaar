...
colnames(hours) <- c("Instructor", "Office", "Office hours")
...
timetable <- data.frame(Week = 1:14) %>% 
  ...
  mutate(Objective = c('Overview of R and Reproducibility',
                       'Reproducibility Continued / R fundamentals and Skills',
                       'R fundamentals and Skills / Data preparation and visualization',
                       'Data preparation and visualization / Basic analytics',
                       'Introduction',
