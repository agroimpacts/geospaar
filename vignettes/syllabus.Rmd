...
Jonas Clark 105 (TA office hours), F 16-17.50

## Office Hours
Instructor | Office | Office hours
---------|------------------|------------------
Lyndon   | Jefferson 105    | Tuesday 1-3 pm
Jordan Frey | | TBD
Dale Watt | | TBD
...
1. ___Assignments in this class are problem-oriented, not recipe-based___: 
    ...
    It can be very rewarding to figure out programming problems (I personally prefer programming to writing papers), but some people can find it boring or even frustrating. If you fall into the latter camp, please consider the possibility that this course might not be for you. Let's discuss.
...
There is no required textbook for this course. There is a huge amount of well-developed R material that is freely available on the web. We draw on those resources for this class and integrate it into our own content. 

__Readings and assignments__ should be completed ___before___ the class they are listed under. This is key to learning the language, ***as you will not learn programming by just listening to lectures.*** 

___Practical assignments___. During the first two units, we will give a number of practical exercises (see links to individual assignments in the [course structure](#structure) section). Unless otherwise stated, these will be assigned on a Monday and due by midnight on Friday of the same week. You will undertake and submit your work through github repositories that exist under the Agricultural Impacts Research Group's github [organization](https://github.com/agroimpacts), where there is a [team](https://github.com/orgs/agroimpacts/teams/geog246346) setup for this class. That means that you will need to join github (it's free!) to be able to submit assignments, as we will need your github name to add you to the team. You will manage your individual assignments under private personal repositories that will be listed under your own individual sub-team.   
...
### Communications
We will conduct class communications via a Slack channel that you should already be invited to. ***Please don't send emails, as they will be ignored***. Class-wide discussions will be conducted in the #spring2019 channel. Individual and restricted group messaging will be conducted via Slack direct messaging, e.g. grade reporting, confidential questions.  

Slack's most obvious characteristic is instant messaging. However, please don't expect an instant response. While I always strive to be responsive, given workloads and the number of students enrolled, we will restrict responses to specific days and times. Since we are running this class as a flipped model, the goal is for all questions to be answered during class (which will be more like lab than lecture). 
...
### Week 7 - Working with vector data
...
## Unit 3. Projects
### Week 11 (Nov 8) - Project selection

### Weeks 12-13 - Project work
