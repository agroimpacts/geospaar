...
+ Required readings:
    ...
    + Regressions: 
        ...
        + This of course assumes that you know what linear regression is and how it works.  If this is new to you, please read this [Beginner's Guide to Regression](https://www.hackerearth.com/practice/machine-learning/machine-learning-algorithms/beginners-guide-regression-analysis-plot-interpretations/tutorial/), which actually includes its own R code and data. However, the explanation of regression is more important. An even more high-level look at OLS is provided by [Harvard Business Review](https://www.hackerearth.com/practice/machine-learning/machine-learning-algorithms/beginners-guide-regression-analysis-plot-interpretations/tutorial/). 
...
Focusing on running and plotting non-linear and non-parametric regressions
...
#### Class 9 (30 Sep). Trends in R
+ Readings: 
    + Emerging evolutionary trajectories in R: 
        + The tidyverse
        + `data.table` and `dplyr`: two different approaches for handling large datasets in R. 

#### Class 10 (2 Oct). Wrap-up

Featuring an exercise to put it all together
