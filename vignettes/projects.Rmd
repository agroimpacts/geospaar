...
Each student will undertake an R-based final project for this class, typically as part of a team. This project is typically drawn from a list of [potential projects below](projects.html#project-list), which are related to ongoing research projects, or could be one related to your own thesis work, which we will discuss and agree upon.  
