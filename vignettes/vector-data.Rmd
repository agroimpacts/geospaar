...
### Summary and final problem to solve{#unit3summary}

This section has given a brief and by no means exhaustive introduction to do some common vector operations. There are a number of other types of operations that we could have looked at, some or many of which we will undoubtedly encounter as we plunge ahead.  

For now, I am going to leave you with a final problem to solve, which takes us back to the farmers dataset. 
