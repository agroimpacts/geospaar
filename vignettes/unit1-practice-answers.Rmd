...
output:
  rmdformats::readthedown:
    ...
    css: unit.css
vignette: >
  %\VignetteIndexEntry{Unit 1 Practice answers}
...
3. 
    a) Have to use both column and row indices to attract row, col subset; 
    b) Can use list notation for `data.frame` (e.g. `m$b`), but not for `matrix`.   
...
2. Would multiply 1st columns of each, 2nd columns of each, and 3rd columns of each.
