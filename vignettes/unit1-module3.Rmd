...
5. Demonstrate the use of `*apply`:
    - Combine `v1`, `m2`, and `m3` into a list `l`
...
3. Can be installed with browsable vignettes using `install_github`. 4. Code written according to Hadley Wickham's R style guide. 
...
7. When complete, park the repo on a new side branch called a2
