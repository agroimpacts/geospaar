...
3. In 2.1.3, please describe (e.g. class, data structure, number of elements) `a` and `l` in Chunk #1. 
4. In 2.1.3 Chunk #4, please describe the operation that we just performed, and what objects are used in it. 
