...
Which you see is done here (changing the value in the same subset to 999, instead of -99, for contrast), but if it is a once-off function that is doing something highly customized, it is perhaps more readable--and adds less clutter to your environment--to use the anonymous function approach. 
