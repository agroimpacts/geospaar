...
- In 2.0.1.2, Chunk 3 #3, #4, and #8, why do we have to use three sets of brackets to get access to the vector elements? Hint: pay attention to the first set of brackets. 
- In 2.0.1.3, please describe (e.g. class, data structure, number of elements) `a` and `l` in Chunk #1. 
- In 2.0.1.3 Chunk #4, please describe the operation that we just performed, and what objects are used in it. 
