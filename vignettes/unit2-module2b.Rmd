...
The DEM we downloaded is in decimal degrees with a resolution of 0.008333333&deg;, which means the area of each pixel varies through Zambia. To illustrate that, we use a nice function that `raster` provides, which lets you calculate the pixel areas, even when the raster is in geographic coordinates:
