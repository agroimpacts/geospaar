...
# Unit Assignment
## Set-up
Make sure you are working in the master branch of your project (you should not be working on the a3 branch. Create a new vignette named "module4.Rmd". You will use this to document the tasks you undertake for this assignment. Rename the previous vignette "module1.Rmd". 
...
## Assignment output
Refer to [Unit 1 Module 3's Assignment output section](unit-module3.html#assignment-output) for submission instructions. The only differences are as follows:
