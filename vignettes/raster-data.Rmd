...
We have a help file in `geospaar` describing `chirps` (`?chirps`), which is roughly a 5 km gridded daily rainfall dataset derived mostly from satellite data, but corrected to weather station observations. Our dataset here is subset over Zambia, and for just less than one month of observations. 
