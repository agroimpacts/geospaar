...
Participation is worth 5% of your final grade and has two components.
- Code work between classes. Students will at times be asked to work on practical problems between classes. The time for this work will not exceed 1 hour. Students should have code examples and provide examples of errors/obstacles. 
- Reading quizzes. Periodically, short quizzes will be given on core concepts from readings. These quizzes will be closed-book and not exceed 10 minutes. (e.g. explain in general terms how an apply function works). Students receiving 60% or higher on a quiz receive a "Complete" grade.
