...
That explains nicely how OOP differs from the alternative programming paradigm (procedural programming). Another useful bit of explanation on OOP is from [Advanced R](http://adv-r.had.co.nz/OO-essentials.html#oo-answers):
...
This last point on namespaces brings us to packages. Packages have their own environments, as well as a namespace environment. Let's let Hadley Wickham [explain this](https://adv-r.hadley.nz/environments.html#basics):
