...
# a / sum(a)
instructor <- 'Lei Song'
office_instructor <- 'Geography building 102A'
hours_instructor <- 'Tuesday 10:00AM - 12:00AM (Virtual appointments only)'
ta <- 'Pilar Delpino Marimón'
office_ta <- ''
hours_ta <- ''
hours <- rbind(c(instructor, office_instructor, hours_instructor), 
            c(ta, office_ta, hours_ta))
colnames(hours) <- c("Instructor/TA", "Office", "Office hours")
