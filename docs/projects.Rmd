...
More details are under preparation.

Here is a cool example on gentrification in the UK: https://carto.com/blog/spatial-analysis-gentrification/
...
Here are a few dataset that we could use: https://www.cdc.gov/gis/index.htm
...
This is part of my current work. It might be a bit experimental and challenging. The general idea is:
