...
brick(s, filename = file.path(tempdir(), "mybrick.tif"), overwrite = TRUE)
# stack(s, filename = file.path(tempdir(), "mydumbstack.tif"), overwrite = TRUE)
brick(s, filename = file.path(tempdir(), "mybrick.grd"), overwrite = TRUE)
# brick(s, filename = file.path(tempdir(), "mybrick.rst"), overwrite = TRUE)
brick(file.path(tempdir(), "mybrick.tif"))
brick(file.path(tempdir(), "mybrick.grd"))

raster(file.path(tempdir(), "mybrick.tif"))
