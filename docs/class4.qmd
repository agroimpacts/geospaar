...
- Things that might still be unclear:
  - Distinctions between some of the key components we are using
...
## Distinguishing the key components

- What is the difference between a container, a repository, and a package? 
- Where do files accessible to your container live on your file system? 
- How did you get `geospaar` into your container-accessible files?
- What is the difference between the `geospaar` directly under `geog246346/`, versus the one under `geog246346/r_4.4.2_packages/`? 

## Setting up... 

...your own package project and repo for assignments

- How do you set up a new git-enabled R package? 
- How do you sync it with GitHub? 
  - What are ssh keys, why do you need them, and how do you make them? 
- Why do we make our assignment repos private? 
...
- With the new branch active, create a new file `test_function` within the R folder. Create a simple function that takes a number `x` as an input, and prints "`x` is my favorite number!". Make sure it has proper documentation. Save and commit this file in the new branch.
...
Synchronizing between local and remote repositories
