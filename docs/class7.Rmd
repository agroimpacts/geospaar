...
- Now you download the zip file (url: ), read all sub-tables and merge them back to a whole table and save out. Then delete all related files except this whole table.
