...
crop_lj <- left_join(crop_rmd_weather, crop_rmd_soil, by = 'label')
# Right join, keep all rows of data on right side.
crop_rj <- right_join(crop_rmd_weather, crop_rmd_soil, by = 'label')
# What I will get if I do this?
crop_lj2 <- left_join(crop_rmd_soil, crop_rmd_weather, by = 'label')

# Inner join, take the common part of data on left and right side.
crop_ij <- inner_join(crop_rmd_weather, crop_rmd_soil, by = 'label')
# Full join, keep all rows of data on both left and right side.
crop_fj <- full_join(crop_rmd_weather, crop_rmd_soil, by = 'label')
```
