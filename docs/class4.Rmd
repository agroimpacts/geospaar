...
## Cloning `geospaar`
- Follow steps in [Unit 1 Module 1 (4.3.4)](https://agroimpacts.github.io/geospaar/unit1-module1.html#syncing-your-repo-using-github)
- Clone `geospaar` instead of your personal repo.
...
- Finish reading Unit1-Module 2 (all)
- Review [R Markdown overview](https://rmarkdown.rstudio.com/lesson-1.html). Read all sections, especially Chunk Options.
- Review [R Package overview](https://r-pkgs.org/structure.html)
- QUIZ WEDNESDAY!!
