...
- format with group value, then aesthetic, e.g. `"Zambia" = "red"`
...
---
## Format is the same for other aesthetics 
...
---
## Binned color 
- See [here](https://ggplot2.tidyverse.org/reference/scale_colour_continuous.html)
...
---
## Exercises
- Create NDVI map of pods with different color for each pod. 
- Create plot of yield vs harvested area by year (maize only).
  - Squares for Zambia, Circles for South Africa  

---
## Exercises
- CHALLENGE: add a continuous color ramp to 2nd plot to reflect the year. 
