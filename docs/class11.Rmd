...
```{r, eval=FALSE}
set.seed(1)
a <- tibble(v1 = sample(1:100, size = 10), v2 = rnorm(10), 
            grp = sample(letters[1:10], size = 10, replace = TRUE))
b <- tibble(v3 = runif(10), 
            grp = sample(letters[1:15], size = 10, replace = TRUE))
left_join(a, b, by = "grp", multiple = "all")
