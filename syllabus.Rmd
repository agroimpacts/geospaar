...
Students are encouraged to work together on lab and other assignments to assist each other in understanding the exercises. However, all contents of each student's assignments (text and graphics) must be authored solely by that student.
...
#### Class 3. Rmarkdown and more on R packages
+ Readings:
...
+ Readings: 
    ...
    + Data types and structures: [rspatial Chapter 2](http://www.rspatial.org/intr/rst/2-basic-data-types.html), [Chapter 3](http://www.rspatial.org/intr/rst/3-basic-data-structures.html), and [Data Structures](http://adv-r.had.co.nz/Data-structures.html)
    + Functions: rspatial's [chapter](http://www.rspatial.org/intr/rst/8-functions.html) on function; read from top through "Primitive Functions" section in Advanced R's chapter on [Functions](http://adv-r.had.co.nz/Functions.html#function-components).  
