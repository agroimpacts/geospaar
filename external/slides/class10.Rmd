...
```{r, echo=FALSE, fig.align="center", fig.cap="From https://www.educba.com/loops-in-r/"}
pth <- glue::glue("https://cdn.educba.com/academy/wp-content/",
                  "uploads/2019/07/Loops-in-R-1.png")
knitr::include_graphics(pth)
```

---
### Branching with looping

```{r}
v <- 1:100
ifelse(v > 50 & v < 70, 0, v)
